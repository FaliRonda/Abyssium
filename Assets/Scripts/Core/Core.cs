...
public static class Core
{
    ...
    public static GamepadVibrationService GamepadVibration =>        ServiceContainer.Get<GamepadVibrationService>();
    public static PostProcessingService PostProcessing =>            ServiceContainer.Get<PostProcessingService>();
    public static PlayerInputService PlayerInput =>                  ServiceContainer.Get<PlayerInputService>();
}