...
namespace Ju.Extensions
{
	public static class IEnumerableExtensions
	{
		...
		public static TSource[] ToArrayJuCore<TSource>(this IEnumerable<TSource> self)
		{
		...
		public static List<TSource> ToListJuCore<TSource>(this IEnumerable<TSource> self)
		{
